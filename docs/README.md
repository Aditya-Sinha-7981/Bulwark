...
> "Aegis" is a placeholder project name — not yet confirmed by the team. Rename freely; it appears only in prose, never in code identifiers, package names, or config keys.

## Reading order

If you're new to this project, read in this order:

1. `project-context.md` — start here, always. Also the file to hand a new AI coding session.
...
Phase 1 (architecture) and Phase 2 (technology/model selection) are **locked**. This documentation set is Phase 3. Implementation has not started. The Orchestrator model benchmark referenced in `models.md` and `testing.md` is a validation activity against an already-selected default (`qwen3.5:9b`) — it does not block starting implementation.
